...
const Hero = (props: Props) => {
  ...
  return (
    <div className="bg-[#000933] min-h-[100vh]  relative">
      ...
      <div className="absolute flex justify-between flex-col p-[24px] lg:p-[80px] gap-5  h-full  top-0 w-full">
        <h2 className="font-euclid text-white text-[48px] md:text-[40px] lg:text-[60px] leading-[56px] lg:leading-[80px] max-w-[382px] lg:max-w-[640px]">
          ...
          <div className="flex flex-col gap-[40px] max-w-[480px]">
            ...
            <div className="flex flex-col lg:flex-row gap-[24px] lg:text-[28px]">
              ...
              <button
                ...
                className="py-[20px] px-[28px] lg:py-[32px] lg:px-[40px] bg-white text-primary font-euclid500 "
              >
                Book a call
              </button>
            </div>
